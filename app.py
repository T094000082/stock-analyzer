...
from core import (
    WATCHLIST_FILE, MAX_WATCHLIST, WISDOM, SIGNAL_CFG, THEMES,
    load_watchlist, save_watchlist, fetch_stock_data,
    get_stock_name, search_stocks, today_wisdom, make_dharma_wheel,
)
...
st.set_page_config(page_title="勸世股經-台股價量評估儀表板", page_icon=make_dharma_wheel(), layout="wide")
st.markdown(
    """
    <style>
